# okx-v5-java
[![GitHub version](https://img.shields.io/static/v1?label=version&message=v0.5.2024072502&color=blue)](https://github.com/forestwanglin/okx-v5-java)
...
<dependency>
    ...
    <version>0.5.2024072502</version>
</dependency>
```
...
```yaml
implementation group: 'xyz.felh', name: 'okx-v5-java', version: '0.5.2024072502'
```

### sbt

```javascript
libraryDependencies += "xyz.felh" % "okx-v5-java" % "0.5.2024072502"
```
